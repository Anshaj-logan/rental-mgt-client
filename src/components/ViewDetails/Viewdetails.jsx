  ...
  return (
    ...
    <div className="row px-xl-5">
        ...
        >
          <div className="carousel-inner border">
            <div className="carousel-item active">
              <img className="w-50 h-100" src="img\images\kathakali\kathakali9.1.jpg" alt="Image"/>
            </div>
            <div className="carousel-item">
              <img className="w-50 h-100" src="img\images\kathakali\kathakali10.1.jpg" alt="Image"/>
            </div>
            <div className="carousel-item">
              <img className="w-50 h-100" src="img\images\kathakali\kathakali7.1.jpg" alt="Image"/>
            </div>
            <div className="carousel-item">
              <img className="w-50 h-100" src="img\images\kathakali\kathakali4.1.jpg" alt="Image"
              />
            </div>
          </div>
          <a
      ...
      <div className="col-lg-7 pb-5">
        <h3 className="font-weight-semi-bold">Kathakali Costumes</h3>
        ...
        <div className="d-flex align-items-center mb-4 pt-2">
          ...
          <a href="/addtocart"><button className="btn btn-primary px-3">
      ...
      <div className="col">
        ...
        <div className="tab-content">
          ...
          <div className="tab-pane fade" id="tab-pane-3">
            <div className="row">
              <div className="col-md-6">
                <h4 className="mb-4">1 review for "kathakali"</h4>
