        ...
        <tbody className="align-middle">
          <tr>
            <td className="align-middle">
              <img src="img\images\kathakali\kathakali4.1.jpg" alt="" style={{ width: 50 }} />{" "}
              Kathakali Costumes
            </td>
      ...
      <div className="card border-secondary mb-5">
        ...
        <div className="card-footer border-secondary bg-transparent">
          <div className="d-flex justify-content-between mt-2">
            ...
            <h5 className="font-weight-bold">550</h5>
          </div>
          <a href="/checkout">
          <button className="btn btn-block btn-primary my-3 py-3" id="proceed">
